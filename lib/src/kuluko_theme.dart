...
abstract class KulukoTheme {
  ...
  static KulukoTheme of(BuildContext context) {
...
class LightModeTheme extends KulukoTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0xFFD3BCFD);
  late Color secondary = const Color(0xFF4F3D74);
  late Color tertiary =const Color.fromARGB(255, 110, 110, 110);
  late Color alternate = const Color(0xFF262D34);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFCBC4CF);
  late Color primaryBackground = const Color(0xFF1D1B1E);
  late Color secondaryBackground = const Color(0xFF151218); 
  late Color accent1 = const Color(0xFFA478F7);
  late Color accent2 = const Color(0x4CFF6A73);
  late Color surfaceContainerHigh = const Color(0xFF2C292F);
...
class DarkModeTheme extends KulukoTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
